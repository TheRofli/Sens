...
const messages = {
  ru: {
    ...
    "visionPack.lite": "Рекомендуемая — Qwen3-VL 2B (~3.4 ГБ пиковой RAM)",
    "visionPack.quality": "Качественная — SmolVLM2-2.2B (~3.2 ГБ пиковой RAM)",
    "visionPack.qualityLarge": "Максимум — Qwen2.5-VL-3B (тяжёлый, по запросу)",
    ...
    "visionPack.ready": "Семантика готова",
    "visionPack.readyHint": "{title} проверен и доступен локально.",
    "visionPack.downloadTitle": "Нужна загрузка модели",
    "visionPack.downloadHint": "Один раз скачайте выбранный GGUF-пакет. Для рекомендуемого Qwen нужно около 1.45 ГБ на диске.",
  ...
  en: {
    ...
    "visionPack.lite": "Recommended — Qwen3-VL 2B (~3.4 GB peak RAM)",
    "visionPack.quality": "Quality — SmolVLM2-2.2B (~3.2 GB peak RAM)",
    "visionPack.qualityLarge": "Maximum — Qwen2.5-VL-3B (large, opt-in)",
    ...
    "visionPack.ready": "Semantics ready",
    "visionPack.readyHint": "{title} is verified and available locally.",
    "visionPack.downloadTitle": "Model download required",
    "visionPack.downloadHint": "Download the selected GGUF pack once. Recommended Qwen uses about 1.45 GB on disk.",
