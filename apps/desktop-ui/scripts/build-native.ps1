...
$manifest = [ordered]@{
    version = $appVersion
    notes = "Sens ${appVersion}: semantic web starters, live DOM text and controls, combined visual/accessibility review, exact symbol art, and bounded compact MCP responses."
